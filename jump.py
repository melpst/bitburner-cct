...
assert minJump([3,3,5,1,5,2,3,0,3,1,2,4,3,2,3,5,7,1,2,2,5,5,3]) == 7
...
assert possibleToEnd([2,9,4,2,10,3,2,9,10,7,8,7,7,0,5]) == 1

hops = [3,3,5,1,5,2,3,0,3,1,2,4,3,2,3,5,7,1,2,2,5,5,3]
print(minJump(hops))